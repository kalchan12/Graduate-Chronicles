                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Stack(alignment: Alignment.center, children: [
                        Container(width: 140, height: 140, decoration: BoxDecoration(color: Colors.transparent, borderRadius: BorderRadius.circular(80))),
                        Positioned(
                          child: Container(
                            width: 112,
                            height: 112,
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [BoxShadow(color: DesignSystem.purpleAccent.withOpacity(0.16), blurRadius: 40, spreadRadius: 6)],
                            ),
                            child: const Icon(Icons.lock_reset, size: 48, color: DesignSystem.purpleAccent),
                          ),
                        ),
                      ]),
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: const Icon(Icons.mail, color: Color(0xFFBDB1C9)),
