                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: const LinearGradient(colors: [Color(0xFFd45eff), DesignSystem.purpleAccent]),
                                boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.4), blurRadius: 20, offset: const Offset(0, 8))],
                              ),
                              child: const Icon(Icons.check_circle, size: 96, color: Colors.white),
                            ),
                            const SizedBox(height: 20),
                            const Text('Password Updated!', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: Colors.white)),
                            const SizedBox(height: 8),
                            const Padding(
                              padding: EdgeInsets.symmetric(horizontal: 32.0),
                              child: Text('Your new password has been set successfully. You can now use it to log in.', textAlign: TextAlign.center, style: TextStyle(color: Color(0xFFD6C9E6))),
                            ),
