...
class _YearbookFilterScreenState extends State<YearbookFilterScreen> {
  final List<Map<String, String>> _students = List.generate(
    ...
    (i) => {
      'name':
          '${['Olivia Chen', 'Benjamin Carter', 'Sophia Rodriguez', 'Liam Goldberg', 'Ava Nguyen', 'Noah Williams'][i % 6]} ${i + 1}',
      'degree': i % 3 == 0
  ...
  List<Map<String, String>> get _filtered => _students
...
Widget _chipAllFilters() => Container(
  ...
  child: Row(
    children: const [
      ...
      SizedBox(width: 8),
      Text('All Filters', style: TextStyle(color: Colors.white)),
    ],
  ),
);
